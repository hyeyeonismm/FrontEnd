				...
				<Grid theme='modal_body'>
					...
					<Grid theme='modal_section'>
						...
						<Grid theme='modal_content'>
							SeedStock은 『신용정보의 이용 및 보호에 관한 법률』, 『개인정보 보호법』등 관련 법령에 따라 개인신용정보를
							처리합니다.
						</Grid>
						<Grid theme='modal_subtitle'>거부할 권리와 불이익</Grid>
						<Grid theme='modal_content'>
							개인신용정보 수집/이용에 동의하지 않을 수 있으나 원활한 서비스 이용을 위해 동의가 꼭 필요합니다. 미동의 시
							본인신용정보 통합조회, 데이터분석 서비스를 이용할 수 없습니다.
						</Grid>
					...
					<Grid theme='modal_section'>
						...
						<Grid theme='modal_subtitle'>거부할 권리와 불이익</Grid>
						<Grid theme='modal_content'>
							개인신용정보 제공에 동의하지 않을 수 있으나, 서비스 이용을 위해서는 동의가 필요합니다. 미동의 시 본인신용정보
							통합조회, 데이터분석, 마이데이터 가입 현황 안내, 전송요구내역 통합조회 서비스 이용이 불가합니다.
						</Grid>
						<Grid theme='modal_subtitle'>정보를 받는 곳</Grid>
						<Grid theme='modal_content'>신한카드</Grid>
						<Grid theme='modal_subtitle'>목적</Grid>
						...
						<Grid theme='modal_subtitle'>보유 · 이용기간</Grid>
						<Grid theme='modal_content'>
							한국신용정보원의 마이데이터서비스 가입현황 안내 및 전송요구내역 통합조회 서비스 목적 달성시까지
						</Grid>
						<Grid theme='modal_subtitle'>제공정보</Grid>
						<Grid theme='modal_content'>
							· 전송요구 내역정보
							<br />
							회원 가입여부, 서비스목록수, 서비스목록, 클라이언트 ID, 전송요구내역수, 전송요구내역목록, 정보제공자기관코드,
							권한범위, 전송요구일자, 전송요구종료시점
						</Grid>
					</Grid>
